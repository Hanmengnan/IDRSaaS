...
class PyTorchGridSearchCV(BaseEstimator, RegressorMixin):
    def __init__(self, input_dim=4, output_dim=4, step_num=5, hidden_dim=64, num_layers=1, epochs=30, batch_size=32, device=None):
    ...
    def fit(self):
        self.model = LSTMModel(self.input_dim, self.output_dim, self.hidden_dim, self.num_layers).to(self.device)
