...
class PyTorchGridSearchCV(BaseEstimator, RegressorMixin):
    def __init__(self, input_dim=4, output_dim=1, step_num=5, hidden_dim=32, nb_blocks_per_stack=3, thetas_dim=4, epochs=80, batch_size=32, device=None):
    ...
    def predict(self):
        ...
        return NBeatsModel.predict(self.model, x_test[:, :, :1], self.device)
