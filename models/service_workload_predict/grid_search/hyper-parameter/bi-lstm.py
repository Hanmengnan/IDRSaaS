...
class PyTorchGridSearchCV(BaseEstimator, RegressorMixin):
    def __init__(self, input_dim=4, output_dim=4, step_num=5, hidden_dim=32, num_layers=2, epochs=50, batch_size=32, device=None):
    ...
    def fit(self):
        ...
        train_model(attention_x_train, y_train, attention_x_val, y_val, self.model, self.epochs, self.batch_size, self.device)
        return self
